    ...
    <div className="min-h-screen">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-14">
        ...
        <div className="container relative z-10 text-center px-4 py-16 md:py-24">
          ...
          <p className="text-h2 text-text-secondary mb-8 animate-fadeUp" style={{ animationDelay: "0.1s" }}>
            Komplexe Projekte. Ein Partner.
          </p>
          <p className="text-body-lg text-text-muted max-w-2xl mx-auto mb-12 animate-fadeUp" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-16 md:mt-24 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="text-center animate-fadeUp" style={{ animationDelay: `${0.4 + index * 0.1}s` }}>
                <div className="text-h1 font-bold text-accent-warm mb-2">{stat.value}</div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <Card key={index} hover className="flex items-start gap-4">
                  <div className="w-6 h-6 rounded-full bg-accent-warm/20 flex-shrink-0 mt-1" />
      ...
      {/* Ihre Vorteile */}
      <section id="vorgehen" className="py-16 md:py-24 bg-surface/50">
        <div className="container">
          <div className="max-w-4xl mx-auto">
      ...
      <section id="referenzen" className="py-16 md:py-24 bg-surface/50">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <Card key={index} hover className="text-center">
                  ...
                  <p className="text-body-sm text-text-secondary">{client.description}</p>
                </Card>
              ))}
            </div>
          </div>
      ...
      {/* Footer */}
      <footer id="ueber-uns" className="bg-text-primary text-surface py-12 md:py-16">
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-body-sm opacity-80">
                <p>Grüner Ring 15</p>
                <p>04509 Delitzsch</p>
                <p className="pt-2">
                ...
                <p>
                  <a href="tel:+493420289988 2" className="hover:opacity-100 transition-opacity">
                    +49 (0) 34202 899882
                  </a>
                </p>
              </div>
          ...
          {/* Bottom Bar */}
          <div className="border-t border-surface/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-body-sm opacity-60">
