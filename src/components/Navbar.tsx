    ...
    return (
        <nav className="navbar">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
                <a href="#vorteile" className="nav-link desktop-only">Warum Nexora</a>
                <a href="#leistungen" className="nav-link desktop-only">Leistungsportfolio</a>
                ...
                <button onClick={onInquiryClick} className="nav-cta">
                    Projekt anfragen
                </button>
            </div>
        </nav>
